...
/* ipv6-tcp */
#define HIKP_RSS_NONFRAG_IPV6_TCP_EN_TCP_D  HI_BIT(32)
#define HIKP_RSS_NONFRAG_IPV6_TCP_EN_TCP_S  HI_BIT(33)
#define HIKP_RSS_NONFRAG_IPV6_TCP_EN_IP_D   HI_BIT(34)
#define HIKP_RSS_NONFRAG_IPV6_TCP_EN_IP_S   HI_BIT(35)

/* ipv6-udp */
#define HIKP_RSS_NONFRAG_IPV6_UDP_EN_UDP_D  HI_BIT(36)
#define HIKP_RSS_NONFRAG_IPV6_UDP_EN_UDP_S  HI_BIT(37)
#define HIKP_RSS_NONFRAG_IPV6_UDP_EN_IP_D   HI_BIT(38)
#define HIKP_RSS_NONFRAG_IPV6_UDP_EN_IP_S   HI_BIT(39)

/* ipv6-sctp */
#define HIKP_RSS_NONFRAG_IPV6_SCTP_EN_SCTP_D    HI_BIT(40)
#define HIKP_RSS_NONFRAG_IPV6_SCTP_EN_SCTP_S    HI_BIT(41)
#define HIKP_RSS_NONFRAG_IPV6_SCTP_EN_IP_D      HI_BIT(42)
#define HIKP_RSS_NONFRAG_IPV6_SCTP_EN_IP_S      HI_BIT(43)
#define HIKP_RSS_NONFRAG_IPV6_SCTP_EN_SCTP_VTAG HI_BIT(44)

/* ipv6-other */
#define HIKP_RSS_NONFRAG_IPV6_OTHER_EN_IP_D   HI_BIT(45)
#define HIKP_RSS_NONFRAG_IPV6_OTHER_EN_IP_S   HI_BIT(46)

/* ipv6-frag */
#define HIKP_RSS_FRAG_IPV6_EN_IP_D   HI_BIT(47)
#define HIKP_RSS_FRAG_IPV6_EN_IP_S   HI_BIT(48)
...
#define RSS_MAX_TUPLES_NAME_LEN 64
	...
	const struct {
		...
		{ "ipv6-tcp", IPV6_TCP, HIKP_RSS_NONFRAG_IPV6_TCP_MASK },
